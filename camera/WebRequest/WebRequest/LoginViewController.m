...
- (IBAction)LoginButtonClick:(id)sender {
    ...
    void (^loginComplete)(void) = ^{
       NSLog(@"LoginViewController Authenticate Complete");
       [[GameStore SharedStore] LoadGames:loadComplete];
    };
    
    [[GameStore SharedStore] Authenticate:username withPassword:password  withBlock:loginComplete];
